...
import com.tzt.customize.base.databinding.ActivityClassicProcessBinding
 ...
 * @since 2020/5/22
 */
class ClassicProcessActivity: BaseActivity<ActivityClassicProcessBinding>() {
    ...
    override fun layoutBinding() = ActivityClassicProcessBinding.inflate(layoutInflater, null, false)
